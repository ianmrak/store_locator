...
class MockUserAgentFailure(object):
    def get(self, url, params):
        return {}

class MockUserAgentInvalid(object):
    def get(self, url, params):
        return {'invalid': {}}
